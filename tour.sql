...
CREATE TABLE `article`  (
  ...
  `status` int(11) NULL DEFAULT 1 COMMENT '状态(0:已发布，1:审核中，2:未通过审核，3:已隐藏)',
  ...
  `goodCount` int(11) NULL DEFAULT 0,
  `keepTryingCount` int(11) NULL DEFAULT 0,
...
CREATE TABLE `product`  (
  ...
  `categoryName` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  ...
  `image1` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '产品主图',
  `image2` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '产品主图',
  `image3` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '产品图片',
  `image4` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '产品图片',
  `image5` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '产品图片',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `sys_config`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1120021297863192579 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_config` VALUES (1120021297863192578, 'content', '{\"social\":[{\"name\":\"Baidu\",\"logo\":\"\",\"url\":\"http://www.baidu.com\",\"isShow\":\"on\",\"order\":\"2\"},{\"name\":\"www\",\"logo\":\"\",\"url\":\"https://www.amazon.com/dp/B00C0KI8YS?psc=1\",\"isShow\":\"on\",\"order\":\"123\"}]}', NULL, '2019-04-22 01:47:41', 4402);
...
CREATE TABLE `sys_file`  (
  ...
  `createDate` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1120279605475868674 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '文件上传' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1120279615118573571 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统日志' ROW_FORMAT = Dynamic;
