...
-- ----------------------------
INSERT INTO `article_tag` VALUES ('31', '17', '3');
INSERT INTO `article_tag` VALUES ('32', '17', '4');
INSERT INTO `article_tag` VALUES ('33', '17', '5');
INSERT INTO `article_tag` VALUES ('34', '10', '6');
...
CREATE TABLE `sys_config` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1120021297863192579 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
INSERT INTO `sys_config` VALUES ('1120021297326321665', 'indexSubTitle', '312', null, '2019-04-22 01:47:41', '4402');
INSERT INTO `sys_config` VALUES ('1120021297531842561', 'indexTitle', '123', null, '2019-04-22 01:47:41', '4402');
...
CREATE TABLE `sys_file` (
  ...
  `createDate` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1120002818296545283 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='文件上传';
...
INSERT INTO `sys_file` VALUES ('1119944248276303873', '0', 'http://localhost/upload/20190421\\8\\f\\post-sample-image.jpg', '2019-04-21 20:41:31');
INSERT INTO `sys_file` VALUES ('1119945201754849282', '0', 'http://localhost/upload/20190421\\5\\8\\post-bg.jpg', '2019-04-21 20:45:18');
INSERT INTO `sys_file` VALUES ('1119946549917401089', '0', 'http://localhost/upload/20190421\\8\\f\\post-sample-image.jpg', '2019-04-21 20:50:40');
INSERT INTO `sys_file` VALUES ('1119946885730156545', '0', 'http://localhost/upload/20190421\\8\\f\\about-bg.jpg', '2019-04-21 20:52:00');
INSERT INTO `sys_file` VALUES ('1119946982014599169', '0', 'http://localhost/upload/20190421\\6\\6\\home-bg.jpg', '2019-04-21 20:52:23');
INSERT INTO `sys_file` VALUES ('1119947435901206529', '0', 'http://localhost/upload/20190421\\6\\6\\home-bg.jpg', '2019-04-21 20:54:11');
INSERT INTO `sys_file` VALUES ('1120002817281523713', '0', 'http://localhost/upload/20190422\\8\\f\\about-bg.jpg', '2019-04-22 00:34:15');
INSERT INTO `sys_file` VALUES ('1120002817537376257', '0', 'http://localhost/upload/20190422\\5\\0\\contact-bg.jpg', '2019-04-22 00:34:15');
INSERT INTO `sys_file` VALUES ('1120002817721925633', '0', 'http://localhost/upload/20190422\\6\\6\\home-bg.jpg', '2019-04-22 00:34:15');
INSERT INTO `sys_file` VALUES ('1120002818015526913', '0', 'http://localhost/upload/20190422\\5\\8\\post-bg.jpg', '2019-04-22 00:34:15');
INSERT INTO `sys_file` VALUES ('1120002818296545282', '0', 'http://localhost/upload/20190422\\8\\f\\post-sample-image.jpg', '2019-04-22 00:34:15');
...
CREATE TABLE `sys_log` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1120021378611933187 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='系统日志';
