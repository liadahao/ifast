...
CREATE TABLE `sys_file` (
  ...
  `createDate` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1117354582574391298 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='文件上传';
...
CREATE TABLE `sys_log` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1117363557571346435 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='系统日志';
...
CREATE TABLE `sys_role_menu` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=5242 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='角色与菜单对应关系';
...
CREATE TABLE `tag` (
  ...
  `type` varchar(255) DEFAULT NULL COMMENT '用途',
  `isEnable` int(1) DEFAULT NULL COMMENT '是否可用',
  `createTime` datetime DEFAULT NULL COMMENT '创建时间按',
