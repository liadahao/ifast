...
CREATE TABLE `app_demo_base`  (
  ...
  `publish` datetime(0) NULL DEFAULT NULL COMMENT '发布时间',
  ...
  `version` smallint(6) NULL DEFAULT 0 COMMENT '版本',
  `createAt` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `updateAt` datetime(0) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `createBy` bigint(20) NULL DEFAULT NULL COMMENT '创建者',
  `updateBy` bigint(20) NULL DEFAULT NULL COMMENT '更新者',
  `price` decimal(10, 0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '基础表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `article`  (
  ...
  `title` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '标题',
  `content` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '内容',
  `editMode` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT 'html' COMMENT '编辑模式，默认为html，其他可选项包括html，markdown ..',
  ...
  `commentCount` int(11) UNSIGNED NULL DEFAULT 0 COMMENT '评论总数',
  `commentTime` datetime(0) NULL DEFAULT NULL COMMENT '最后评论时间',
  ...
  `flag` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '标识，通常用于对某几篇文章进行标识，从而实现单独查询',
...
-- Records of article
-- ----------------------------
INSERT INTO `article` VALUES (1, NULL, '1236548daaa', '<p>qfewf23rh9sdyvwbi1</p>\n', 'html', 'nihao', NULL, NULL, 1, NULL, 'normal', 1, 3, NULL, 22, '2019-03-22 18:55:08', '2019-03-22 18:57:42', NULL, NULL, NULL, NULL, 0);
INSERT INTO `article` VALUES (2, NULL, 'svbdbdb', '<p>416164984egeg</p>\n', 'html', NULL, NULL, NULL, 1, NULL, 'normal', 0, 0, NULL, 7, '2019-03-22 18:55:52', '2019-03-22 18:59:07', NULL, NULL, NULL, NULL, 0);
...
CREATE TABLE `sys_config`  (
  ...
  `k` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '键',
  `v` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '值',
  `remark` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  `createTime` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `kvType` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `sys_dept`  (
  ...
  `parentId` bigint(20) NULL DEFAULT NULL COMMENT '上级部门ID，一级部门为0',
  `name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '部门名称',
  `orderNum` int(11) NULL DEFAULT NULL COMMENT '排序',
  `delFlag` tinyint(4) NULL DEFAULT 0 COMMENT '是否删除  -1：已删除  0：正常',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `sys_dict`  (
  ...
  `parentId` bigint(64) NULL DEFAULT 0 COMMENT '父级编号',
  `createBy` int(64) NULL DEFAULT NULL COMMENT '创建者',
  `createDate` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `updateBy` bigint(64) NULL DEFAULT NULL COMMENT '更新者',
  ...
  `delFlag` char(1) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT '0' COMMENT '删除标记',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `sys_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1115208115608985603 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统日志' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_menu`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `parentId` bigint(20) NULL DEFAULT NULL COMMENT '父菜单ID，一级菜单为0',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1115184208369717257 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '菜单管理' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_menu` VALUES (1115180108840210434, 1115179024377745410, '文章内容管理', '', '', 1, '', NULL, NULL, NULL);
INSERT INTO `sys_menu` VALUES (1115180279120564226, 1115179024377745410, '活动内容管理', '', '', 1, '', NULL, NULL, NULL);
INSERT INTO `sys_menu` VALUES (1115182776430137345, 0, '商品模块', '', '', 0, 'fa fa-pencil-square-o', 1, NULL, NULL);
INSERT INTO `sys_menu` VALUES (1115182861398347778, 1115182776430137345, '商品类别管理', '', '', 1, '', NULL, NULL, NULL);
INSERT INTO `sys_menu` VALUES (1115182933116751873, 1115182776430137345, '商品管理', '', '', 1, '', NULL, NULL, NULL);
...
INSERT INTO `sys_menu` VALUES (1115183358557589505, 1115183012166799361, '导航管理', '', '', 1, '', NULL, NULL, NULL);
...
INSERT INTO `sys_menu` VALUES (1115184208369717251, 1, '文章表', '/cms/article', '', 1, 'fa fa-file-code-o', 6, NULL, NULL);
...
CREATE TABLE `sys_role`  (
  ...
  `roleSign` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '角色标识',
  `remark` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  `userIdCreate` bigint(255) NULL DEFAULT NULL COMMENT '创建用户id',
  `gmtCreate` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `gmtModified` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1034088931742957570 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '角色' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_role_menu`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4844 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '角色与菜单对应关系' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_role_menu` VALUES (4767, 1, 193);
INSERT INTO `sys_role_menu` VALUES (4768, 1, 194);
INSERT INTO `sys_role_menu` VALUES (4769, 1, 195);
INSERT INTO `sys_role_menu` VALUES (4770, 1, 196);
INSERT INTO `sys_role_menu` VALUES (4771, 1, 197);
INSERT INTO `sys_role_menu` VALUES (4772, 1, 79);
INSERT INTO `sys_role_menu` VALUES (4773, 1, 80);
INSERT INTO `sys_role_menu` VALUES (4774, 1, 81);
INSERT INTO `sys_role_menu` VALUES (4775, 1, 83);
INSERT INTO `sys_role_menu` VALUES (4776, 1, 176);
INSERT INTO `sys_role_menu` VALUES (4777, 1, 177);
INSERT INTO `sys_role_menu` VALUES (4778, 1, 178);
INSERT INTO `sys_role_menu` VALUES (4779, 1, 179);
INSERT INTO `sys_role_menu` VALUES (4780, 1, 180);
INSERT INTO `sys_role_menu` VALUES (4781, 1, 207);
INSERT INTO `sys_role_menu` VALUES (4782, 1, 208);
INSERT INTO `sys_role_menu` VALUES (4783, 1, 209);
INSERT INTO `sys_role_menu` VALUES (4784, 1, 210);
INSERT INTO `sys_role_menu` VALUES (4785, 1, 211);
INSERT INTO `sys_role_menu` VALUES (4786, 1, 20);
INSERT INTO `sys_role_menu` VALUES (4787, 1, 21);
INSERT INTO `sys_role_menu` VALUES (4788, 1, 22);
INSERT INTO `sys_role_menu` VALUES (4789, 1, 61);
INSERT INTO `sys_role_menu` VALUES (4790, 1, 12);
INSERT INTO `sys_role_menu` VALUES (4791, 1, 13);
INSERT INTO `sys_role_menu` VALUES (4792, 1, 14);
INSERT INTO `sys_role_menu` VALUES (4793, 1, 24);
INSERT INTO `sys_role_menu` VALUES (4794, 1, 25);
INSERT INTO `sys_role_menu` VALUES (4795, 1, 26);
INSERT INTO `sys_role_menu` VALUES (4796, 1, 15);
INSERT INTO `sys_role_menu` VALUES (4797, 1, 55);
INSERT INTO `sys_role_menu` VALUES (4798, 1, 56);
INSERT INTO `sys_role_menu` VALUES (4799, 1, 62);
INSERT INTO `sys_role_menu` VALUES (4800, 1, 74);
INSERT INTO `sys_role_menu` VALUES (4801, 1, 75);
INSERT INTO `sys_role_menu` VALUES (4802, 1, 76);
INSERT INTO `sys_role_menu` VALUES (4803, 1, 48);
INSERT INTO `sys_role_menu` VALUES (4804, 1, 72);
INSERT INTO `sys_role_menu` VALUES (4805, 1, 28);
INSERT INTO `sys_role_menu` VALUES (4806, 1, 29);
INSERT INTO `sys_role_menu` VALUES (4807, 1, 30);
INSERT INTO `sys_role_menu` VALUES (4808, 1, 57);
INSERT INTO `sys_role_menu` VALUES (4809, 1, 92);
INSERT INTO `sys_role_menu` VALUES (4810, 1, 1115180108840210434);
INSERT INTO `sys_role_menu` VALUES (4811, 1, 1115180279120564226);
INSERT INTO `sys_role_menu` VALUES (4812, 1, 1115182861398347778);
INSERT INTO `sys_role_menu` VALUES (4813, 1, 1115182933116751873);
INSERT INTO `sys_role_menu` VALUES (4814, 1, 1115183358557589505);
INSERT INTO `sys_role_menu` VALUES (4815, 1, 1115183444654067714);
INSERT INTO `sys_role_menu` VALUES (4816, 1, 1115184160676286466);
INSERT INTO `sys_role_menu` VALUES (4817, 1, 1115184208369717250);
INSERT INTO `sys_role_menu` VALUES (4818, 1, 1115183213711495170);
INSERT INTO `sys_role_menu` VALUES (4819, 1, 1115183247500808194);
INSERT INTO `sys_role_menu` VALUES (4820, 1, 71);
INSERT INTO `sys_role_menu` VALUES (4821, 1, 78);
INSERT INTO `sys_role_menu` VALUES (4822, 1, 175);
INSERT INTO `sys_role_menu` VALUES (4823, 1, 206);
INSERT INTO `sys_role_menu` VALUES (4824, 1, 2);
INSERT INTO `sys_role_menu` VALUES (4825, 1, 6);
INSERT INTO `sys_role_menu` VALUES (4826, 1, 7);
INSERT INTO `sys_role_menu` VALUES (4827, 1, 73);
INSERT INTO `sys_role_menu` VALUES (4828, 1, 3);
INSERT INTO `sys_role_menu` VALUES (4829, 1, 77);
INSERT INTO `sys_role_menu` VALUES (4830, 1, 27);
INSERT INTO `sys_role_menu` VALUES (4831, 1, 91);
INSERT INTO `sys_role_menu` VALUES (4832, 1, 1115179024377745410);
INSERT INTO `sys_role_menu` VALUES (4833, 1, 1115182776430137345);
INSERT INTO `sys_role_menu` VALUES (4834, 1, 1115183012166799361);
INSERT INTO `sys_role_menu` VALUES (4835, 1, 1115183127149449218);
INSERT INTO `sys_role_menu` VALUES (4836, 1, 1115184208369717251);
INSERT INTO `sys_role_menu` VALUES (4837, 1, 1115184208369717252);
INSERT INTO `sys_role_menu` VALUES (4838, 1, 1115184208369717253);
INSERT INTO `sys_role_menu` VALUES (4839, 1, 1115184208369717254);
INSERT INTO `sys_role_menu` VALUES (4840, 1, 1115184208369717255);
INSERT INTO `sys_role_menu` VALUES (4841, 1, 1115184208369717256);
INSERT INTO `sys_role_menu` VALUES (4842, 1, 1);
INSERT INTO `sys_role_menu` VALUES (4843, 1, -1);
...
CREATE TABLE `sys_task`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `cronExpression` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'cron表达式',
  `methodName` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '任务调用的方法名',
  `isConcurrent` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '任务是否有状态',
  ...
  `beanClass` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '任务执行时调用哪个类的方法 包名+类名',
  `createDate` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `jobStatus` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '任务状态',
  ...
  `springBean` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'Spring bean',
  `jobName` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '任务名',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1020572889410367491 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_user`  (
  ...
  `picId` bigint(32) NULL DEFAULT NULL,
  `liveAddress` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '现居住地',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1034088697579159555 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_user_role`  (
  ...
  `roleId` bigint(20) NULL DEFAULT NULL COMMENT '角色ID',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 134 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户与角色对应关系' ROW_FORMAT = Dynamic;
...
CREATE TABLE `wx_mp_config`  (
  ...
  `appSecret` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'AppSecret',
  `msgMode` int(11) NULL DEFAULT NULL COMMENT '1加密 0不加密',
  `msgSecret` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `mpName` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '公众号名字',
  `appType` int(11) NOT NULL COMMENT '公众号类型： 1.订阅号 2.服务号 3.企业号 4.小程序 5. 测试号',
  `isAuth` int(11) NULL DEFAULT NULL COMMENT '认证授权：1已认证 0未认证',
  `subscribeUrl` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '提示订阅URL',
  `appKey` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '开放的公众号key',
  `logo` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `createTime` datetime(0) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '微信配置表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `wx_mp_fans`  (
  ...
  `openid` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '用户的标识，对当前公众号唯一',
  `nickname` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '昵称',
  `subscribe` tinyint(4) NULL DEFAULT NULL COMMENT '用户是否订阅该公众号标识，值为0时，代表此用户没有关注该公众号，拉取不到其余信息。0未关注，1已关注',
  `subscribeTime` datetime(0) NULL DEFAULT NULL COMMENT '用户关注时间，为时间戳。如果用户曾多次关注，则取最后关注时间',
  `subscribeKey` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '关注来源',
  ...
  `headimgurl` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '用户头像，最后一个数值代表正方形头像大小（有0、46、64、96、132数值可选，0代表640*640正方形头像），用户没有头像时该项为空。若用户更换头像，原有头像URL将失效。',
  `unionid` varchar(125) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `remark` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '公众号运营者对粉丝的备注，公众号运营者可在微信公众平台用户管理界面对粉丝添加备注',
  `groupid` int(20) NULL DEFAULT NULL COMMENT '分组ID',
  `status` tinyint(11) NULL DEFAULT NULL COMMENT '用户状态 1:正常，0：禁用',
  `tagidList` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2905 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '微信粉丝表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `wx_mp_menu`  (
  ...
  `parentIdx` bigint(20) NULL DEFAULT NULL,
  `menuType` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '菜单类型：1主菜单，2链接，3文本，4关键字，5扫码，6发图，7发送位置',
  `menuName` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `menuKey` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `menuUrl` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '菜单链接',
  `replyContent` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `scanType` int(4) NULL DEFAULT NULL COMMENT '扫码类型：1扫码带事件，2扫码带提示',
  `pictureType` int(4) NULL DEFAULT NULL COMMENT '发图类型：1，系统拍照发图；2,，拍照或者相册发图；3，微信相册发图',
  `location` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '发送位置',
  `sort` int(11) NULL DEFAULT NULL COMMENT '菜单排序',
  `status` int(4) NULL DEFAULT NULL COMMENT '菜单状态',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '微信菜单表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `wx_mp_wechat_keys`  (
  ...
  `mediaId` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '素材Id',
  `keyword` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '关键字，以#,#隔开',
  `type` tinyint(4) NULL DEFAULT NULL COMMENT '回复类型，1：关键字 2：关注自动回复 3：默认回复',
  `replyType` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '回复类型，文字：text 图文：news 图片： image 语音：voice 音乐：music 视频：video',
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '内容',
  `newsId` bigint(20) NULL DEFAULT NULL COMMENT '图文素材Id',
  `musicTitle` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '音乐标题',
  `musicCover` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '音乐封面',
  `musicUrl` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '音乐url',
  `musicDesc` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '音乐描述',
  `imageUrl` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '图片URL',
  `voiceUrl` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '音频URL',
  `videoTitle` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '视频标题',
  `videoUrl` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '视频url',
  `videoDesc` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '视频描述',
  `createTime` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `updateTime` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  `status` tinyint(4) NOT NULL DEFAULT 1 COMMENT '状态 0：禁用 1：启用',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '微信-关键字回复' ROW_FORMAT = Dynamic;
