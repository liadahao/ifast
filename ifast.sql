...
CREATE TABLE `category`  (
  ...
  `onShelvesNum` int(11) NULL DEFAULT NULL,
  `offShelvesNum` int(11) NULL DEFAULT NULL,
...
CREATE TABLE `event`  (
  ...
  `address` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `nav`  (
  ...
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '导航名称',
  `background` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '背景图',
...
-- Records of nav
-- ----------------------------
INSERT INTO `nav` VALUES (33, 'techtour', NULL, '/techtour', 1, 2, 0, NULL, '{\"title\":\"1212\",\"content\":\"121\",\"video\":\"\",\"order\":\"\",\"model1title\":\"\",\"model1content\":\"\",\"model1video\":\"\",\"model1order\":\"\",\"model2title\":\"\",\"model2content\":\"\",\"model2video\":\"\",\"model2order\":\"\",\"model3title\":\"\",\"model3content\":\"\",\"model3video\":\"\",\"model3order\":\"\",\"model4title\":\"\"}');
...
CREATE TABLE `product`  (
  ...
  `name` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '产品名称',
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '产品简要描述',
  `detail` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '产品详细描述',
  `image` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '产品主图',
  `price` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '价格',
  `sale` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '打折价',
  `url` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '跳转url',
  `order` int(11) NULL DEFAULT NULL COMMENT '排序',
  `tags` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '标签',
